...
class LTPageView: UIView {
    ...
    fileprivate lazy var pageTitleView: UIView = {
    ...
    fileprivate lazy var scrollView: UIScrollView = {
        let scrollView = UIScrollView(frame: CGRect(x: 0, y: self.layout.sliderHeight ?? 44.0, width: self.bounds.width, height: self.bounds.height - (self.layout.sliderHeight ?? 44.0)))
